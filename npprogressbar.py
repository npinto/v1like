...
class ProgressBar(object):
    ...
    def _need_update(self):
        # NP: update at every decimal
        return (self.percentage()-self.prev_percentage) >= 1e-1
...
# ------------------------------------------------------------------------------
# NP: to get current filename
class FilenameUpdate(object):
    def __init__(self, fnames):
        self.fnames = fnames

    def update(self, pbar):
        return self.fnames[pbar.currval-1]#[-50:]
